...
<?php if (@$_GET["success"] == "true") { ?>
    <div class="alert alert-success" role="alert">
        Terima Kasih Telah Mendaftar, Anda akan dihubungi dalam waktu 2 x 24 jam.
    </div>
<?php } ?>
    ...
    <div class="formulir">
        <form method="POST" action="send-email.php">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nama" class="form-control" id="inputNama" aria-describedby="namaHelp" placeholder="Nama" required>
            </div>
            <div class="form-group">
                <label for="inputNoHP">No HP*</label>
                <input type="text" name="hp" class="form-control" id="inputNoHP" aria-describedby="hpHelp" placeholder="No HP" required>
            </div>
            <div class="form-group">
            ...
            <button type="submit" class="btn btn-danger btn-block" id="kirim">KIRIM</button>
        </form>
    </div>
</div>
